...
static const char qt_meta_stringdata_OpenGLWindow[] = {
    "OpenGLWindow\0\0updateWindow()\0"
};
...
const QMetaObjectExtraData OpenGLWindow::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject OpenGLWindow::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_OpenGLWindow,
      qt_meta_data_OpenGLWindow, &staticMetaObjectExtraData }
};
