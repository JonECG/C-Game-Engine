...
void Graphics::setFrameBuffer( FrameBufferObject * fbo )
{
	if( fbo )
	{
...
void Graphics::showFullscreen()
{
	handle->setWindowState( Qt::WindowFullScreen );// -> showFullScreen();
}


void Graphics::setAutoBufferSwap( bool autoSwap )
{
	handle->setAutoBufferSwap( autoSwap );
}